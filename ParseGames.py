...
class ParseGames:
    ...
    def update_new_games(self) -> Dict[str, List[Game]]:
        """
        ...
        newly_finished_games: Dict[str, List[Game]] = {}
    ...
    def write_newly_finished_games(self, newly_finished_games: Dict[str, List[Game]]):
        """
